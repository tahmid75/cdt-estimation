...
int DemoSafetyMessage::getId() const
{
    return this->id;
}

void DemoSafetyMessage::setId(int id)
{
    this->id = id;
}
...
void DemoSafetyMessage::setSenderSpeedRLDCO(float speed)
{
    this->senderSpeedRLDCO = speed;
}

float DemoSafetyMessage::getSenderSpeedRLDCO()
{
    return this->senderSpeedRLDCO;
}


/*void DemoSafetyMessage::setSenderPositionRLDCO(const Coord& vehiclePos)
{
    //std::cout << vehiclePos;
    this->senderPositionRLDCO = vehiclePos;
    //std::cout << this->senderPositionRLDCO ;
}

Coord& DemoSafetyMessage::getSenderPositionRLDCO()
{
    //std::cout << this->senderPositionRLDCO ;
    return this->senderPositionRLDCO;
}*/

void DemoSafetyMessage::setHopCountRLDCO(int hopCount){
    this->hopCountRLDCO = hopCount;
}

int DemoSafetyMessage::getHopCountRLDCO(){
