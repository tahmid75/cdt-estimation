...
class VEINS_API DemoSafetyMessage : public ::veins::BaseFrame1609_4
{
  protected:
    ...
    //Tahmid Starts. Initializing new attributes to send through WSM.

    float senderSpeedRLDCO;
  ...
  public:
    ...
    //Tahmid Starts. Declaring new functions.
    virtual void setSenderSpeedRLDCO(float speed); // Why virtual
    virtual float getSenderSpeedRLDCO();

    virtual void setHopCountRLDCO(int hopCount);
    virtual int getHopCountRLDCO();
